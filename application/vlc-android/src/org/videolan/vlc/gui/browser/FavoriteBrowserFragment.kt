...
class FavoriteBrowserFragment : BaseFragment(), View.OnClickListener, CtxActionReceiver {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.favorite_browser_fragment, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        favoritesEntry.list.layoutManager=LinearLayoutManager(context,LinearLayoutManager.VERTICAL,false)
    ...
    inner class MainBrowserContainer(
            ...
            override val inCards: Boolean = false
        ...
        override fun onCtxClick(v: View, position: Int, item: MediaLibraryItem) {
            ...
            if (actionMode == null && item.itemType == MediaLibraryItem.TYPE_MEDIA) lifecycleScope.launch {
                ...
                if (flags != 0L) {
                    showContext(requireActivity(), this@FavoriteBrowserFragment, position, item.getTitle(), flags)
